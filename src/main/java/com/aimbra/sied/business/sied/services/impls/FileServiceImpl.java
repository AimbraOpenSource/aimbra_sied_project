...
public class FileServiceImpl implements FileService {
    ...
    public void init() {
        try {
            this.root = Paths.get("storage/" + this.aulaId);
    ...
    public RecursoDto save(MultipartFile file, AulaDto aulaDto) {
        try {
            ...
            RecursoDto recursoDto = RecursoBuilder.create("storage/" + this.aulaId.toString(), LocalDateTime.now(), logicName, file.getOriginalFilename(), LocalDateTime.now(), aulaDto);
